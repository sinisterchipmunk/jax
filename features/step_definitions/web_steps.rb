...
Then /^(?:|I )should see an? "([^"]*)" element with attribute "([^"]*)" starting with "([^"]*)"$/ do |element_name, attribute_name, attribute_value|
  page.should have_xpath("//#{element_name}[starts-with(@#{attribute_name},'#{attribute_value}')]")
end
