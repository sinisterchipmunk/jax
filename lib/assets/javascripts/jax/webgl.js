...
(function() {
  ...
  if (gl) {
    ...
    Jax.getGlobal()['GL_DEPTH_COMPONENT'] = GL_DEPTH_COMPONENT || GL_DEPTH_COMPONENT16;
    Jax.getGlobal()['GL_TEXTURES'] = [];
    for (i = 0; i < 32; i++) Jax.getGlobal()['GL_TEXTURES'][i] = gl["TEXTURE"+i];
    Jax.getGlobal()['GL_MAX_ACTIVE_TEXTURES'] = gl.getParameter(GL_MAX_VERTEX_TEXTURE_IMAGE_UNITS);
  }
