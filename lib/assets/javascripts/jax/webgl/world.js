...
Jax.World = (function() {
  ...
  return Jax.Class.create({
    ...
    render: function(material) {
      ...
      this.context.gl.blendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);

      if (this.lighting.isEnabled() && (!material || (material.supportsLighting && material.supportsLighting()))) {
        /* illumination pass */
        this.context.current_pass = Jax.Scene.ILLUMINATION_PASS;
        this.lighting.illuminate(this.context, material);
