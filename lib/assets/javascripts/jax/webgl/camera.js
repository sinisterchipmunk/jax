...
Jax.Camera2 = (function() {
  ...
  return Jax.Class.create({
    initialize: function(options) {
      ...
      if (options) {
        if (options.position)  this.setPosition(Jax.Util.vectorize(options.position));
        if (options.direction) this.setDirection(Jax.Util.vectorize(options.direction));
      }
    },
 ...
 **/
Jax.Camera2.prototype.setViewVector = Jax.Camera2.prototype.setDirection;

Jax.Camera2.addMethods(Jax.Events.Methods);
