...
Jax.OldMesh = (function() {
  ...
  return Jax.Class.create({
    ...
    getNormalizedRenderOptions: function(options) {
      ...
      options.default_material = options.default_material || this.default_material;
      options.draw_mode = this.draw_mode === undefined ? GL_TRIANGLES : this.draw_mode;
      if (!options.material) options.material = options.default_material;
      options.material = Jax.Util.findMaterial(options.material);
      return options;
    },
...
Jax.OldMesh.addMethods(Jax.Events.Methods);
