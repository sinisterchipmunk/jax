 ...
 **/
mat4.IDENTITY = GLMatrix.mat4.identity(GLMatrix.mat4.create());
 ...
 * in the glMatrix library.)
 **/
quat.IDENTITY = GLMatrix.quat.identity(GLMatrix.quat.create());
 ...
 * in the glMatrix library.)
 **/
vec3.UNIT_X = GLMatrix.vec3.clone([1,0,0]);
 ...
 * in the glMatrix library.)
 **/
vec3.UNIT_Y = GLMatrix.vec3.clone([0,1,0]);
 ...
 * in the glMatrix library.)
 **/
vec3.UNIT_Z = GLMatrix.vec3.clone([0,0,1]);
