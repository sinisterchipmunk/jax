(function() {
  ...
  function coplanar_tri_tri(N, V0, V1, V2, U0, U1, U2) {
    var A = bufs.tritri_A = bufs.tritri_A || GLMatrix.vec3.create();
    var i0, i1;
  ...
  {
    var E1 = bufs.tritri_E1 = bufs.tritri_E1 || GLMatrix.vec3.create(),
        E2 = bufs.tritri_E2 = bufs.tritri_E2 || GLMatrix.vec3.create(),
        N1 = bufs.tritri_N1 = bufs.tritri_N1 || GLMatrix.vec3.create(),
        N2 = bufs.tritri_N2 = bufs.tritri_N2 || GLMatrix.vec3.create(),
        D  = bufs.tritri_D  = bufs.tritri_D  || GLMatrix.vec3.create(),
        isect1 = bufs.tritri_isect1 = bufs.tritri_isect1 || GLMatrix.vec2.create(),
        isect2 = bufs.tritri_isect2 = bufs.tritri_isect2 || GLMatrix.vec2.create();
    var d1, d2;
    ...
    GLMatrix.vec3.subtract(E1, V1, V0);
    GLMatrix.vec3.subtract(E2, V2, V0);
    GLMatrix.vec3.cross(N1, E1, E2);
    d1 = -GLMatrix.vec3.dot(N1, V0);
    /* plane equation 1: N1.X+d1=0 */

    /* put U0,U1,U2 into plane equation 1 to compute signed distances to the plane*/
    du0 = GLMatrix.vec3.dot(N1, U0) + d1;
    du1 = GLMatrix.vec3.dot(N1, U1) + d1;
    du2 = GLMatrix.vec3.dot(N1, U2) + d1;
    ...
    GLMatrix.vec3.subtract(E1, U1, U0);
    GLMatrix.vec3.subtract(E2, U2, U0);
    GLMatrix.vec3.cross(N2, E1, E2);
    d2 = -GLMatrix.vec3.dot(N2, U0);
    /* plane equation 2: N2.X+d2=0 */

    /* put V0,V1,V2 into plane equation 2 */
    dv0 = GLMatrix.vec3.dot(N2, V0) + d2;
    dv1 = GLMatrix.vec3.dot(N2, V1) + d2;
    dv2 = GLMatrix.vec3.dot(N2, V2) + d2;
