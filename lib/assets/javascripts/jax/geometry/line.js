...
Jax.Geometry.Line = (function() {
  ...
  var Line = Jax.Class.create({
    ...
    contains: function(point) {
      ...
      var pa = vec3.subtract(point,  this.a, bufs.pa || (bufs.pa = vec3.create()));
      var ab = vec3.subtract(this.a, this.b, bufs.ab || (bufs.ab = vec3.create()));
      var pb = vec3.subtract(point,  this.b, bufs.pb || (bufs.pb = vec3.create()));
