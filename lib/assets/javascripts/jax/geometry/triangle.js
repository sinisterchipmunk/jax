...
Jax.Geometry.Triangle = (function() {
  ...
  var Triangle = Jax.Class.create({
    ...
    isClockwise: function(xform) {
      ...
      var a, b, c;
      if (xform) {
        mat4.multiplyVec3(xform, this.a, v1);
        mat4.multiplyVec3(xform, this.b, v2);
        mat4.multiplyVec3(xform, this.c, v3);
        a = v1;
        b = v2;
        c = v3;
      } else {
      ...
      vec3.subtract(b, a, v1);
      vec3.subtract(c, a, v2);
    ...
    recalculateCenter: function() {
      // (a+b+c) / 3
      vec3.add(this.a, this.b, this.center);
      vec3.add(this.c, this.center, this.center);
    ...
    recalculateNormal: function() {
      ...
      vec3.subtract(this.b, this.a, this.normal);
      vec3.subtract(this.c, this.a, tmp);
