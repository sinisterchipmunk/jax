...
Jax.Context = (function() {
  ...
  function requestFrame(func, canvas) {
    if (Jax.useRequestAnimFrame) return requestAnimationFrame(func, canvas);
    else return setTimeout(func, 16);
  }
    ...
    function render(currentTime) {
      ...
      try {
        ...
        if (self.current_view) {
          self.render();
          if (self.isRendering()) {
            self.render_interval = requestFrame(render, self.canvas);
