...
Jax.MatrixStack = (function() {
  ...
  function updateModelView(self) {
    mat4.multiply(self.getViewMatrix(), self.getModelMatrix(), self.getModelViewMatrix());
    mat4.inverse(self.getModelViewMatrix(), self.getInverseModelViewMatrix());
    updateMVP(self);
    updateNormal(self, self.getModelViewMatrix(), self.getNormalMatrix());
  }
  
  function updateNormal(self, xformmat, nmat) {
    mat4.toInverseMat3(xformmat, nmat);
    mat3.transpose(nmat);
  }
  ...
  function vMatrixUpdated(self) {
    ...
    updateModelView(self);
    updateNormal(self, self.getViewMatrix(), self.getViewNormalMatrix());
  }
  ...
  return Jax.Class.create({
    ...
    getViewNormalMatrix: function() { return this.matrices.view_normal[this.depth]; },
    getInverseViewNormalMatrix: function() { return this.matrices.inverse_view_normal[this.depth]; },
    ...
    initialize: function() {
      ...
      this.matrices = {
        ...
        view_normal: [mat3.create()],
        inverse_view_normal: [mat3.create()],
