...
Keyboard events are generally easier to map because there are no confusing axes to worry about; however, handling them properly involves a little more source code than mouse events.
...
With this variable in place, create two more actions for handling +key_down+ and +key_released+ events:
