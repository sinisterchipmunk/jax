...
When a plugin is generated, its version number defaults to "1.0.0" -- or, initial stable release. If you are uncertain as to your plugin's stability, you should consider reducing the first number to "0" to signify that the plugin has not yet reached maturity.
